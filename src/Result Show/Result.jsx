    ...
    return (
        <>
            <div className="container">
                ...
                <div className="row">
                    <div className="col-8">
                        <span> <b> NAME:</b> </span> <span> {rolln[0].PERSONAL.name} </span> <br />
                        <span> <b> DOB:</b> </span> <span> {rolln[0].PERSONAL.DOB} </span><br />
                        <span> <b> Roll No:</b> </span> <span> {rolln[0].PERSONAL.rollNo} </span><br />
                    </div>
                    <div className="col-4 d-flex justify-content-end  1">
                        <div className="img-container text-bg-danger me-2">
